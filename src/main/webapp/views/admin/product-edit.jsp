                ...
                <div class="container">
                    ...
                    <select name="cateId" required>
                        ...
                        <c:forEach items="${categories}" var="cate">
                            <option value="${cate.categoryid}" ${product.category !=null &&
                                product.category.categoryid==cate.categoryid ? 'selected' : '' }>${cate.categoryname}
                            </option>
                        </c:forEach>
                    </select>
                    ...
                    <div class="current-img">
                        <c:choose>
                            <c:when
                                test="${not empty product.image && product.image.length() >= 5 && product.image.substring(0,5) == 'https'}">
