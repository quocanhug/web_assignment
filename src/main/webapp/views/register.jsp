...
<head>
    ...
    <style>
        ...
        .container { max-width: 480px; margin: 0 auto; background: white; padding: 40px; border-radius: 12px; box-shadow: 0 10px 40px rgba(0,0,0,0.2); }
        h2 { text-align: center; color: #333; margin-bottom: 25px; }
        label { display: block; margin-top: 15px; font-weight: bold; color: #555; font-size: 14px; }
        input[type="text"], input[type="email"], input[type="password"], input[type="tel"] { width: 100%; padding: 12px; margin-top: 5px; border: 1px solid #ddd; border-radius: 6px; box-sizing: border-box; font-size: 14px; transition: border-color 0.3s; }
...
<body>
    <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/account/register" method="post">
            ...
            <input type="text" name="fullname" value="${not empty fullname ? fullname : param.fullname}" placeholder="Nhập họ và tên" required/>
            ...
            <input type="tel" name="phone" value="${not empty phone ? phone : param.phone}" placeholder="Ví dụ: 0912345678"/>
