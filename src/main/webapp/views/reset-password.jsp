        ...
        <body>
            <div class="container">
                ...
                <form action="${pageContext.request.contextPath}/account/reset-password" method="post">
                    ...
                    <input type="text" name="otp" value="${not empty otp ? otp : param.otp}" maxlength="6"
                        placeholder="000000" class="otp-input" required autofocus />
                    <span id="otp.errors">${errors.otp}</span>

                    <label>Mật khẩu mới: <span style="color:red;">*</span></label>
                    <input type="password" name="newPassword" placeholder="Nhập mật khẩu mới (tối thiểu 6 ký tự)"
                        required />
